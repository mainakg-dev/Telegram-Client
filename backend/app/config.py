...
# Interval in seconds for auto-recovering ERRORED and FLOOD_WAIT accounts (dynamic from env)
ACCOUNT_RECOVERY_INTERVAL_SECONDS = int(os.getenv("ACCOUNT_RECOVERY_INTERVAL_SECONDS", "60"))
